...
export class Canvadata {
	...
	placeholderList: any = {
		lean: {
			...
			case9: 'Un message clair et compact : Vous devez vous poser de nouveau ces questions pour être certain d’avoir bien identifié vos valeurs ajoutées et déni votre promesse : en quoi votre offre répond-elle efficacement aux besoins du marché? En quoi est-elle différente et meilleure que les autres? Votre proposition de valeur doit pouvoir être formulée en une phrase avec une accroche unique et inédite. Une proposition de valeur est une promesse de la valeur que vous êtes capable de délivrer. C’est la principale raison qui fait que vos prospects devraient dépenser chez vous plutôt que chez la concurrence. En une phrase, la proposition de valeur est une déclaration claire qui explique comment votre produit résout les problèmes des clients, améliore leur situation et fournit des avantages spécifques.'},
		bmc: {
	...
	initData(canvatype) {
		console.log('canvadata : '+canvatype);
